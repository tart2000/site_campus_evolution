           ...
           ?>
              ...
              <div class="col-xs-6 left">
                <?php if($prev = $page->prev()): ?>
                  <a class="btn btn-effect" href="<?php echo $prev->url() ?>"><i class="fa fa-arrow-left"></i> <?php echo $prev->num(); ?> - <?php echo $prev->title() ?></a>
                <?php endif; ?>
                </div>

              <div class="col-xs-6 right">
                <?php if($next = $page->next()): ?>
                  <a class="btn btn-effect" href="<?php echo $next->url() ?>"><?php echo $next->num(); ?> - <?php echo $next->title() ?>  <i class="fa fa-arrow-right"></i></a>
                <?php endif; ?>
              </div>
          </div>
